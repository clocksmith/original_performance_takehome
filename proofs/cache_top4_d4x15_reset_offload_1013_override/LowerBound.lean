...
namespace ProofCacheTop4D4x15ResetOffload1013Override
open ProofCommon
...
def totalVALU1013 : Nat :=
  totalVALU + VECTORS * RESET_VALU_OPS_PER_VEC + EXTRA_ADDR_VALU_OPS + SETUP_VALU_OPS

lemma totalVALU1013_eq : totalVALU1013 = 7870 := by
  simp [totalVALU1013, totalVALU_eq, VECTORS, RESET_VALU_OPS_PER_VEC, EXTRA_ADDR_VALU_OPS, SETUP_VALU_OPS]

/-- Offload needed at totalCycles and its ALU feasibility. -/
def offloadNeeded (T : Nat) : Nat := totalVALU1013 - VALU_CAP * T

lemma offload_needed_1013 : offloadNeeded totalCycles = 826 := by
  simp [offloadNeeded, totalCycles, totalVALU1013_eq, VALU_CAP]

lemma offloadCap_1013 : offloadCap totalCycles = 1761 := by
  native_decide

lemma offload_feasible_1013 :
    offloadNeeded totalCycles ≤ offloadCap totalCycles := by
  have hcap : offloadCap totalCycles = 1761 := offloadCap_1013
  have hneeded : offloadNeeded totalCycles = 826 := offload_needed_1013
...
lemma alu_capacity_1013 : totalALUOps totalCycles ≤ ALU_CAP * totalCycles := by
  native_decide
...
theorem schedule_skeleton :
  ...
  totalCycles = 1174 := by
  refine ⟨offload_needed_1013, offload_feasible_1013, alu_capacity_1013, flow_capacity_1013, load_capacity_1013, store_capacity_1013, rfl⟩
...
/-! ### Setup assumptions for 1013 (simplified) -/
...
end ProofCacheTop4D4x15ResetOffload1013Override
