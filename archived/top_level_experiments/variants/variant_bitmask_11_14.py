...
# Let rounds 11-14 use the global bitmask selection instead of forcing eq.
SPEC_BITMASK_11_14 = replace(
...
class KernelBuilder(BaseKernelBuilder):
    def build_kernel(self, forest_height: int, n_nodes: int, batch_size: int, rounds: int):
        self.instrs = build_base_instrs(spec=SPEC_BITMASK_11_14)
